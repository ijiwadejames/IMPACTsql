...
import { updateProfile, reset } from "./features/perProfile/perProfileSlice";
...
const validationSchema = Yup.object({
  country: Yup.string()
    ...
    .matches(/^[a-zA-Z- ]+$/, "Invalid Country Option"),
  phone: Yup.string()
...
const UpdatePersonalProfileForm = ({ profile }) => {
  const dispatch = useDispatch();
  const { isSuccess } = useSelector((state) => state.perProfiles);
                  ...
                  {({ field }: FieldProps) => (
                    <div className="mb-1">
                      ...
                      >
                        ...
                        <option value="Nigeria" className="fw-semibold">
                          Nigeria
                        </option>
...
export default UpdatePersonalProfileForm;
