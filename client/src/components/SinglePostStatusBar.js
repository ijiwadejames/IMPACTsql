...
import SingleUnlikeButton from "./SingleUnlikeButton";
import SingleLikeButton from "./SingleLikeButton";
      ...
      <div className="status-bar-items">
        <div className="items">
          {post.likedBy?.some((likes) => likes.userID === (user && user.id)) ? (
            <>
              <SingleUnlikeButton key={post.id} post={post} />
            </>
          ) : (
            <>
              <SingleLikeButton key={post.id} post={post} />
            </>
          )}
        </div>
        <div className="items">
      ...
      <div className="p-0 m-0">
        {toggleDiscussion && (
          <div className="col-11 mt-3 m-auto">
            ...
            <div>
              <SingleCommentBox key={post.id} post={post} />
            </div>
          </div>
        )}
      </div>
